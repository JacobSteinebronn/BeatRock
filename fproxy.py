...
async def get_host():
    try: 
        ...
        fetch_response = await client.get("https://raw.githubusercontent.com/JacobSteinebronn/BeatRock/main/orchestrator_host.txt")
...
async def start_background_task(app): app['background_task'] = asyncio.create_task(update_orchestrator())
